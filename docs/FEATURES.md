...
- **What:** Weave preset **Mask · B&W · Plain** (`mask-bw-plain`): Quartz palette, black warp/weft, near-white BG, plain weave, colorways and shimmer off. **Why:** one-click black-and-white mask for export/cutouts.
...
- **What:** Mosaic **Preset** control (Weave & colorway): **Mask · B&W · Plain** applies Quartz black warp/weft stitches, near-white BG, plain draft, **Background gaps** on (dark→black stitches, bright→white gaps), halftone off. Shared id with Weave mask preset. **Why:** same one-click B&W silhouette mask from the loaded image.
