...
- **What:** Weave preset **Mask · B&W · Plain** (`mask-bw-plain`): Quartz palette, black warp/weft, **Transparent** BG, plain weave, colorways and shimmer off. **Why:** one-click black-and-white mask with see-through gaps for export/cutouts.
...
- **What:** Weave & colorway consolidated: Look / Color / Draft / palette / unified BG / Warp·Weft; one group reset (no per-field resets). **Why:** shorten the mosaic sidebar.
